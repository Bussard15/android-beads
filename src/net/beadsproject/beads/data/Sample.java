...
public class Sample implements Runnable {
	 ...
	 * @throws AudioFileUnsupportedException 
	 */
	public Sample(String filename, Regime r) throws IOException
	{    	
		this();
		setBufferingRegime(r);
		setFile(filename);
	 ...
	 * @throws AudioFileUnsupportedException 
	 */
	public Sample(InputStream is, Regime r) throws IOException
	{    	
		this();
		setBufferingRegime(r);
		setFile(is);
	 ...
	 * 
	 */
	private void setFile(InputStream is) throws IOException
	{
